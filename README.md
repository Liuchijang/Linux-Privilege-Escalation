...
UUID=xxxx-xxxx-xxxx-xxxx  /home  ext4  defaults,nosuid,nodev,noexec  0  2
/dev/sdax  /home  ext4  defaults,nosuid,nodev,noexec  0  2
...
|---|---|
|/|\<without option\>|
|/boot|nosuid, nodev, noexex (optional noauto)|
|/opt|nosuid, nodev (optional ro)|
|/tmp|nosuid, nodev, noexec|
|/srv|nosuid, nodev (optional noexec, ro)|
...
|Option|Description|
|---|---|
|nosuid|option prevents the operation of setuid and setgid bits|
|noexec|option prevents the execution of binaries|
|nodev|option prevents the use of device files (typically found in the /dev) |
|ro|read-only|
|noauto|prevents automatic mounting of the filesystem at boot time|
...
# Remove with their home directory and mail spool
